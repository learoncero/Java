...
//	puts player on the starting field
	...
	public void printGameInformation() {
		...
		System.out.println("   Spiel beenden: [exit]                                                            ");
		System.out.println("------------------------------------------------------------------------------------");
	}
	
	public static void defineMap(GameController gc) {
		// create fields, doors, walls and define surroundings
				...
				Poison apple = new Poison("Apfel", "Nach außen ein stinknormaler Apfel, aber pass auf: Wurde vergiftet!");
				...
				// add players in LinkedList
				_instance.addPlayerGC(player1);
				_instance.addPlayerGC(player2);
				_instance.addPlayerGC(player3);
				_instance.addPlayerGC(player4);
				
				// set startfield for current player
				_instance.setStartField(player1);
	...
	public String save() {
		_gameState = new GameState(_fields, _players);
		String output = _gameState.save();
		return output;
	}
	...
	public String load() {
		...
		if (_gameState != null) {
			_fields = _gameState.getFields();
			_players = _gameState.getPlayers();
	...
	public static void main(String[] args) {
		...
		System.out.println(gc.load());
		Player player = (gc.getPlayers()).getFirst();
		...
		/*
		gc.setStartField(player);
		System.out.println(gc.getCurrPosString(player));
		System.out.println();
		
		player.pickUpItem("Heiltrank");
		System.out.println(gc.getInventoryString(player));
