...
public class Instructor {
	...
	public Instructor (int persNumber, String firstName, String lastName) {
...
//	end getter and setter
	...
	public String toString() {
		return "Instructor [_persNumber=" + _persNumber + ", _fName=" + _fName + ", _lName=" + _lName
				+ ", _appointments=" + _appointments + ", getPersNumber()=" + getPersNumber() + ", getfName()="
				+ getfName() + ", getlName()=" + getlName() + ", getAppointments()=" + getAppointments() + "]";
	}
}
